...
python llava/eval/model_vqa_loader.py \
    ...
    --answers-file /home/usr/liao/datasets/MLLM/eval/pope/answers/llava-v1.5-7b.jsonl \
    --temperature 0 \
    --method transprune \
...
python llava/eval/eval_pope.py \
    ...
    --question-file /home/usr/liao/datasets/MLLM/eval/pope/llava_pope_test.jsonl \
    --result-file /home/usr/liao/datasets/MLLM/eval/pope/answers/llava-v1.5-7b.jsonl
