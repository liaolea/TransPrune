...
python -m llava.eval.model_vqa_loader \
    ...
    --answers-file /home/usr/liao/datasets/MLLM/eval/textvqa/answers/llava-v1.6-7b.jsonl \
    --temperature 0 \
    --method transprune \
...
python -m llava.eval.eval_textvqa \
    ...
    --result-file /home/usr/liao/datasets/MLLM/eval/textvqa/answers/llava-v1.6-7b.jsonl
